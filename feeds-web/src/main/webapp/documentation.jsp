...
<p>RSS 1.0, RSS 2.0 and Atom feeds are supported. The feeds items MUST contain categories or subjects; otherwise Just Map It! Feeds won't be able to produce a map.</p>
...
<h2><a name="addjmif">Add Just Map It! Feeds</a></h2>
